        ...
        <div class="row">
            <div class="col-12">
                <div class="headline" style="padding-bottom: 0px;">
                    <h2 style="color: var(--mainColor);"><?php echo $page_home['home_feature_title']; ?></h2>
        ...
        <div class="row">
            ...
            foreach ($features as $row) {
                ...
                <div class="col-lg-4 col-md-6" >
                    ...
                    style="min-height: 170px; border:1px solid var(--mainColor); border-radius: 3px">
                       
                        <div class="feature-text">

                            <h4 style="color: var(--mainColor);"><?php echo $row['name']; ?></h4>
                            <p>
                                <?php echo nl2br($row['content']); ?>
                            </p>
                        </div>
            ...
            foreach ($portfolio as $row) {
                ...
                <div class="col-lg-4 col-md-6 filtr-item" data-category="<?php echo $row['category_id']; ?>" data-sort="Menu">
                    <div class="portfolio-group">
                        <div class="portfolio-photo" style="background-image: url(<?php echo base_url(); ?>public/uploads/portfolio_photos/<?php echo $row['photo']; ?>)">
                            <div class="portfolio-bg"></div>
                            <div class="portfolio-table">
                                <div class="portfolio-icon">
                                    <a href="<?php echo base_url(); ?>public/uploads/portfolio_photos/<?php echo $row['photo']; ?>" class="magnific"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="services-item effect-item">
                        <a href="<?php echo base_url(); ?>services/view/<?php echo $row['id']; ?>" class="image-effect">
                            <div class="services-photo" style="background-image: url(<?php echo base_url(); ?>public/uploads/services/<?php echo $row['photo']; ?>); background-size: cover; background-position: center;"></div>
                        </a>
                        <div class="services-text" style="background-color: var(--mainFaded)">
                            <h3><a href="<?php echo base_url(); ?>services/view/<?php echo $row['id']; ?>"><?php echo substr($row['name'],0,30); ?>...</a></h3>
                            <!--<p>
                                <?php echo nl2br($row['short_description']); ?>
                            </p>-->
                            <div class="button-bn" >
                                <a href="<?php echo base_url(); ?>services/view/<?php echo $row['id']; ?>"><?php echo DETAILS; ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row" >
            <div class="col-12 text-center">
                <h2>See why you should trust us!</h2>
                <br>
            </div>
            <div class="col-12">
